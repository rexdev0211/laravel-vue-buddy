...
if(!empty($_SESSION['ckeditorUploadImage'])){	
	$baseUrl .= "://".$_SERVER["SERVER_NAME"].'/'.$_SESSION['ckeditorUploadImage'].'/';
}else{
...
if(!empty($_SESSION['ckeditorUploadPath'])){	
	$baseDir = $_SESSION['ckeditorUploadPath'];
}else{
	$baseDir = dirname(dirname(dirname(dirname(__FILE__)))).'/';
}
