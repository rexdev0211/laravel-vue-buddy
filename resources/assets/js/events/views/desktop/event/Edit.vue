<template>
	<div class="secondary-menu create-event" v-if="eventOriginal">
		<div class="secondary-menu-header">
		  	<i class="back" @click="openEvent(eventOriginal.id, 'event')"></i>
		  	...
		  	<div class="tab-content-wrapper event-category-tabs"
				...
				<div class="tab-content-inner">
                  ...
                  <div class="optional-info-note" v-if="type === 'guide'">
                    <label>
                      <input type="text" placeholder="Note to us" v-validate="{max: 300}" v-bind:data-vv-as="trans('note')" v-model="note" name="note">
   ...
   import { VueEditor, Quill } from "vue2-editor";
	 ...
	 export default {
        ...
        titleRequired() {
		  ...
		  mounted() {
              console.log('[Edit Event desktop] Mounted', {
              ...
              this.$nextTick(() => {
                if (this.type == 'guide') {
                  this.$refs.eventMap.$refs.osmMap.mapObject.invalidateSize()
                }
              })
