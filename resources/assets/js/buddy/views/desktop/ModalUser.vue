        ...
        <div class="secondary-menu profile">
            ...
            <div class="secondary-menu-body" id="card" data-reveal2>
                <div class="secondary-menu-header">
                    <i class="back" @click="closeUserModal"></i>
                    <div class="info"
...
<!--                                        <div class="tap sweat" v-on:click="waveToUser(userId, 'sweat', $event)"></div>-->
                ...
                <vue-custom-scrollbar class="profile-footer" v-if="user.about || user.height || user.weight || user.body || user.position || user.penis || user.hiv || user.drugs || notDefaultPublicPhotos && notDefaultPublicPhotos.length || user && user.public_videos.length">
                    <div class="box">
                ...
                <div class="media-list" v-if="notDefaultPublicPhotos && notDefaultPublicPhotos.length || user && user.public_videos.length">
                    <vue-horizontal
                        :button="notDefaultPublicPhotos.length > 4"
                        ref="photo-catalog"
                        class="pics-catalog"
                        v-if="notDefaultPublicPhotos.length > 0">
                    ...
                    <vue-horizontal
                        :button="user.public_videos.length > 4"
                        ref="video-catalog"
                        class="pics-catalog"
                        v-if="user.public_videos.length > 0">
                        <div v-for="video in user.public_videos"
                             class="pic video"
                             :id="'video' + video.id"
        ...
        <UserPhotosReveals v-if="user" :photos="user.public_photos"></UserPhotosReveals>
        <UserVideosReveals v-if="user" :videos="user.public_videos"></UserVideosReveals>
...
<script>
    ...
    // Vue horizontal for media block
