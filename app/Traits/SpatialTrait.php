...
use Grimzy\LaravelMysqlSpatial\Eloquent\BaseBuilder;
...
trait SpatialTrait
{
     ...
     *
     * TODO: conflict with HybridRelations, method updated
     */
    public function newEloquentBuilder($query)
    {
        if (is_subclass_of($this, \Jenssegers\Mongodb\Eloquent\Model::class)) {
            return new \Jenssegers\Mongodb\Eloquent\Builder($query);
        }

//        return new \Jenssegers\Mongodb\Helpers\EloquentBuilder($query);
